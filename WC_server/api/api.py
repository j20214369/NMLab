...
#     print(resp_obj)
    ...
    model_name = "ArcFace"; distance_metric = "cosine"; detector_backend = "opencv"; max_threshold_to_verify=0.4;
    if "max_threshold_to_verify" in list(req.keys()):
        max_threshold_to_verify = req["max_threshold_to_verify"]
...
def representWrapper(req, trx_id = 0):
    ...
    model_name = "Facenet"; distance_metric = "cosine"; detector_backend = 'opencv'
    ...
    if "img" in list(req.keys()):
        raw_content = req["img"] #list
        # print(raw_content)
        for j, item in enumerate(raw_content): #item is in type of dict
            # instance = []
            img1 = item[f"img{j}"]
        ...
        # exit(0)    
            ...
            try:
                # print(type(img))
                resp_obj = {}
                embedding = DeepFace.represent(img1
                    , model_name = model_name
                    , detector_backend = detector_backend
                )
